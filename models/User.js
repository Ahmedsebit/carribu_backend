...
const User = sequelize.define('User', {
  ...
  pendingPickupAddress: { type: DataTypes.TEXT, field: 'pending_pickup_address' },
  pendingPickupLat: { type: DataTypes.DECIMAL(10,7), field: 'pending_pickup_lat' },
  pendingPickupLng: { type: DataTypes.DECIMAL(10,7), field: 'pending_pickup_lng' },
  pendingPickupRequestedAt: { type: DataTypes.DATE, field: 'pending_pickup_requested_at' },
  ...
  fcmPushToken: { type: DataTypes.STRING(2048), field: 'fcm_push_token' },
